...
import 'package:pay_your/resources/custom_package/search_field_inernal.dart';
import 'package:pay_your/resources/custom_package/search_type_internal.dart';

import 'custom_dropdown_internal.dart';
import 'item_list_internal.dart';
                              ...
                              children: [
                                ...
                                if (onSearch &&
                                  ...
                                  if (!widget.hideSelectedFieldWhenOpen!)
                                    ...
                                    widget.searchType ==
                                        SearchType.onRequestData)
                                  if (!widget.hideSelectedFieldWhenOpen!)
                                    SearchField.forRequestData(
                                      items: filteredItems,
                                    ...
                                    Padding(
                                      ...
                                      child: Row(
                                        children: [
                                          Expanded(
                                            child: SearchField.forRequestData(
                                              items: filteredItems,
                                              onFutureRequestLoading: (val) {
                                                setState(() {
                                                  isSearchRequestLoading = val;
