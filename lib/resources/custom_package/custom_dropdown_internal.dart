...
import 'package:pay_your/resources/custom_package/drop_down_field_internal.dart';
import 'package:pay_your/resources/custom_package/search_type_internal.dart';

import 'dropdown_overlay.dart';
import 'overlay_builder_internal.dart';

enum _SearchType { onListData, onRequestData }

typedef ListItemBuilder = Widget Function(BuildContext context, String result);
